...
export default function NewConsultationPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('http://localhost:3001/consultations', {
        method: 'POST',
        headers: {
      ...
      if (response.ok) {
        ...
        router.push(`/dashboard/consultations/${newConsultation.id}`);
      } else {
      ...
      <div className="bg-white rounded-lg shadow overflow-hidden">
        ...
        <form onSubmit={handleSubmit} className="p-6">
          ...
          <div className="mt-6 flex justify-end space-x-3">
            <Link href="/dashboard/consultations" className="bg-white py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
              Cancel
            </Link>
            <button
              type="submit"
